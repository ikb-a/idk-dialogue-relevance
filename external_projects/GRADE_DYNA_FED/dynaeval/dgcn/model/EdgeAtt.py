...
class EdgeAtt(nn.Module):
    ...
    def __init__(self, g_dim, args):
        ...
        self.max_dialogue_len = args.max_dialogue_len
    ...
    def forward(self, node_features, text_len_tensor, edge_ind):
        ...
        for i in range(batch_size):
            ...
            for j in range(cur_len):
                ...
                probs = F.softmax(score, dim=0)  # [L'] #probs = F.softmax(score)  # [L']
                alpha[j, s: e + 1] = probs
            alphas.append(alpha)
